...
const BulkUpload = (props: any) => {
    ...
    const generateSampleCSV = () => {
        const rows_products = [
            ...
            ['Product 1', 'Category1', 'ID001', 'SHANTANU', 'SKU001-A', 'Child 1 of P1', 'Red', '100', '80', '60', '10', '5', '2', '12', '6', '3', '1.5', 'in stock'],
            ['Product 1', 'Category1', 'ID001', 'SHANTANU', 'SKU001-B', 'Child 2 of P1', 'Blue', '150', '120', '90', '15', '7', '3', '17', '8', '4', '2.0', 'out of stock'],
            ['Product 2', 'Category2', 'ID002', 'SHANTANU', 'SKU002-A', 'Child 1 of P2', 'Green', '200', '160', '130', '20', '10', '5', '22', '12', '6', '3.0', 'discontinued'],
        ];
        const rows_Supplier = [
